...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| village | 303 → 28 (10.8×) | 304 → 29 | 36.7k → 36.7k | 0.71 / 0.01 → 0.71 / 0.01 | 0 → 0 | 0.34 → 0.34 | 310 / 310 → 325 / 34 | 158 → 158 | 0 → 0 | 0.00 → 0.00 | 4 → 5 | 1.5 → 0.9 | 16.9 → 16.3 |
| forest | 5706 → 13 (438.9×) | 5707 → 10 | 391.1k → 99.3k | 0.84 / 0.00 → 0.57 / 0.00 | 0 → 0 | 0.40 → 0.28 | 7.0k / 7.0k → 7.0k / 15 | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 4 → 4 | 14.5 → 1.8 | 117.6 → 80.4 |
| crowd | 401 → 17 (23.6×) | 402 → 18 | 151.6k → 151.6k | 0.86 / 0.00 → 0.87 / 0.00 | 0 → 0 | 0.41 → 0.41 | 2.2k / 2.2k → 19 / 18 | 271.0k → 0 | 0 → 0 | 0.00 → 0.00 | 15 → 18 | 3.0 → 0.5 | 33.6 → 31.3 |
| bossfight | 2780 → 370 (7.5×) | 2787 → 294 | 161.7k → 175.7k | 1.04 / 0.64 → 1.04 / 0.64 | 7.6k → 7.6k | 0.81 → 0.81 | 1.5k / 1.5k → 1.5k / 442 | 16.4k → 16.4k | 3.67M → 3.67M | 3.00 → 3.00 | 110 → 110 | 14.1 → 7.7 | 113.8 → 123.9 |
| lake | 3548 → 7 (506.9×) | 3549 → 8 | 8.0k → 8.2k | 0.63 / 0.70 → 0.63 / 0.70 | 1.8k → 1.8k | 0.64 → 0.64 | 2.0k / 2.0k → 2.0k / 2.0k | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 11 → 11 | 14.9 → 1.4 | 87.2 → 73.7 |
| daynight | 605 → 28 (21.6×) | 606 → 29 | 73.4k → 36.7k | 0.71 / 0.01 → 0.71 / 0.01 | 0 → 0 | 0.34 → 0.34 | 310 / 310 → 325 / 34 | 158 → 158 | 4.19M → 2.10M | 1.00 → 0.50 | 20 → 21 | 2.8 → 1.2 | 30.5 → 27.2 |
| zen | 3540 → 88 (40.2×) | 3541 → 62 | 63.2k → 60.9k | 0.64 / 0.00 → 0.64 / 0.00 | 0 → 0 | 0.31 → 0.31 | 50.1k / 50.1k → 226 / 194 | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 91 → 47 | 24.8 → 1.0 | 97.4 → 70.1 |
| rpg | 4 → 1 (4.0×) | 5 → 2 | 365 → 365 | 0.24 / 0.00 → 0.24 / 0.00 | 0 → 0 | 0.09 → 0.09 | 10 / 10 → 6 / 6 | 326 → 326 | 0 → 0 | 0.00 → 0.00 | 3 → 3 | 0.3 → 0.2 | 16.7 → 16.7 |
...
| scene | submissions naive → opt | gpu draws | triangles | overdraw opaque / transparent | particles | fill MPix | objects / auto-matrices | skinned verts | shadow texels | shadow passes/frame | memory MB | render ms | frame ms |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| village | 303 → 28 (10.8×) | 304 → 304 | 36.7k → 36.7k | 0.71 / 0.01 → 0.71 / 0.01 | 0 → 0 | 0.34 → 0.34 | 310 / 310 → 325 / 34 | 158 → 158 | 0 → 0 | 0.00 → 0.00 | 4 → 5 | 2.3 → 1.4 | 16.7 → 16.7 |
| forest | 5706 → 13 (438.9×) | 5707 → 10 | 391.1k → 99.3k | 0.84 / 0.00 → 0.58 / 0.00 | 0 → 0 | 0.40 → 0.28 | 7.0k / 7.0k → 7.0k / 15 | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 4 → 4 | 14.3 → 2.3 | 16.5 → 16.6 |
| crowd | 401 → 17 (23.6×) | 402 → 18 | 151.6k → 151.6k | 0.86 / 0.00 → 0.86 / 0.00 | 0 → 0 | 0.41 → 0.41 | 2.2k / 2.2k → 19 / 18 | 271.0k → 0 | 0 → 0 | 0.00 → 0.00 | 15 → 18 | 3.2 → 1.1 | 16.6 → 16.7 |
| bossfight | 2780 → 370 (7.5×) | 2787 → 1082 | 161.7k → 175.7k | 1.04 / 0.63 → 1.04 / 0.63 | 7.6k → 7.6k | 0.80 → 0.80 | 1.5k / 1.5k → 1.5k / 442 | 16.4k → 16.4k | 3.67M → 3.67M | 3.00 → 3.00 | 110 → 110 | 12.5 → 8.0 | 16.7 → 16.6 |
| lake | 3548 → 7 (506.9×) | 3549 → 34 | 8.0k → 8.2k | 0.63 / 0.69 → 0.63 / 0.69 | 1.8k → 1.8k | 0.63 → 0.63 | 2.0k / 2.0k → 2.0k / 2.0k | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 11 → 11 | 13.6 → 2.3 | 16.5 → 16.7 |
| daynight | 605 → 28 (21.6×) | 606 → 304 | 73.4k → 36.7k | 0.71 / 0.01 → 0.71 / 0.01 | 0 → 0 | 0.34 → 0.34 | 310 / 310 → 325 / 34 | 158 → 158 | 4.19M → 2.10M | 1.00 → 0.50 | 20 → 21 | 3.2 → 1.9 | 16.6 → 16.4 |
| zen | 3540 → 88 (40.2×) | 3541 → 62 | 63.2k → 60.9k | 0.64 / 0.00 → 0.64 / 0.00 | 0 → 0 | 0.31 → 0.31 | 50.1k / 50.1k → 226 / 194 | 0 → 0 | 0 → 0 | 0.00 → 0.00 | 91 → 47 | 24.8 → 1.7 | 25.3 → 16.6 |
| rpg | 4 → 1 (4.0×) | 5 → 2 | 365 → 365 | 0.24 / 0.00 → 0.24 / 0.00 | 0 → 0 | 0.09 → 0.09 | 10 / 10 → 6 / 6 | 326 → 326 | 0 → 0 | 0.00 → 0.00 | 3 → 3 | 0.9 → 0.6 | 16.7 → 16.7 |
