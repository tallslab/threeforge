...
describe('bench gate', () => {
  ...
  it('exports the metric lists', () => {
    ...
    expect(DETERMINISTIC).toEqual(expect.arrayContaining(['particles', 'fillMegapixels', 'objects', 'autoUpdatedMatrices', 'shadowPassesPerFrame']));
