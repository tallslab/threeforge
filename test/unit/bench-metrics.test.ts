...
describe('benchMetrics', () => {
  it('maps a snapshot to the pnpm bench metric keys', () => {
    ...
    expect(metricsOf(frame, 2.5, 16.7)).toEqual({ sceneSubmissions: 12, gpuDraws: 30, triangles: 1000, programs: 3, overdrawOpaque: 1.5, overdrawTransparent: 0.25, skinnedVertices: 400, shadowCasters: 2, shadowTexels: 4096, textureBytes: 10, geometryBytes: 20, renderTargetBytes: 30, particles: 7, fillMegapixels: 0.84, objects: 512, autoUpdatedMatrices: 12, renderMs: 2.5, frameMs: 16.7, unattributed: 0 });
