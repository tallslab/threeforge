...
threeforge 0.9.1 is a frame-budget compiler and diagnostics layer for three.js games (r186, WebGPU with a
...
```json
{
  "schemaVersion": 2, "tool": "threeforge", "version": "0.9.1", "command": "analyze",
