...
threeforge 0.6.0 is a frame-budget compiler and diagnostics layer for three.js games (r186, WebGPU with a
...
```json
{
  "schemaVersion": 1, "tool": "threeforge", "version": "0.6.0", "command": "analyze",
